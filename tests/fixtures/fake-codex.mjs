  ...
  findings: [
    {
      ...
      file: process.env.FAKE_CODEX_FILE || "example.txt",
      line_start: Number(process.env.FAKE_CODEX_LINE_START || 1),
      line_end: Number(process.env.FAKE_CODEX_LINE_END || process.env.FAKE_CODEX_LINE_START || 1),
      pre_existing: false,
      trigger: "Any call.",
